...
public class InterfazIniciarSesion {
	...
	public static void menuIniciarSesion(Galeria galeriaActual) {
		...
		if (r1==1) {
			try {
				galeriaActual = CentralPersistencia.cargarDatos("Usuarios.json", "PiezasEnInventario.json","PagosRegistrados.json");
			...
			try {
				CentralPersistencia.salvarDatos(galeriaActual, "Usuarios.json", "PiezasEnInventario.json","PagosRegistrados.json");
				menuIniciarSesion(galeriaActual);
