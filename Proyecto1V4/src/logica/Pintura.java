...
public class Pintura extends Pieza {
	...
	public Pintura(String titulo, String anio, String lugarCreacion, List<Artista> artistas, String observaciones,
	...
	public String toString() {
		...
		return "Pintura [dimensiones=" + dimensiones + ", material=" + material + ", titulo=" + titulo + ", tipo="
				+ tipo + ", anio=" + anio + ", lugarCreacion=" + lugarCreacion + ", artistas=" + artistasString
