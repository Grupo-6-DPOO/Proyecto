...
public class InterfazAdministrador {
	...
	private static void menuManejarConsignaciones(Galeria galeria) {
		...
		galeria.revisarConsignacion(fecha);
	...
	private static void menuAgregarPieza(Galeria galeria) {
		...
		if (r1 == 1) {
			...
			List<String> autores= new ArrayList<String>(Arrays.asList(pedirCadenaAlUsuario("Ingrese los autores (separados por coma)").split(",")));
			...
			Pieza pintura = new Pintura(titulo, anio, lugarCreacion, autores, observaciones, dimensiones, material);
			...
			Pieza escultura = new Escultura(titulo, anio, lugarCreacion, autores, observaciones, dimensiones, material,peso,necesitaElectricidad);
			...
			String salidaConsignacion = pedirCadenaAlUsuario("Fecha salida consignación(formato DD/MM/YYY, si no está en consignación, digte _)");
			String usuarioDuenio = pedirCadenaAlUsuario("Documento dueño");
			String puedeSalirDeGaleria = pedirCadenaAlUsuario("Puede salir de galería (SI/NO)");
			boolean puedeSalir= true;
			if (puedeSalirDeGaleria.equals("SI")) {
				puedeSalir=true;
			...
			Pieza fotografia = new Fotografia(titulo, anio, lugarCreacion, autores, observaciones, resolucion);
			...
			Pieza video = new Video(titulo, anio, lugarCreacion, autores, observaciones, duracion, resolucion);
